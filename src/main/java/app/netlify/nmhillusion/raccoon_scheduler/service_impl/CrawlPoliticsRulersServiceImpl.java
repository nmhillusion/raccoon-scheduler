...
//        getLog(this).info("pageContent: " + pageContent);
        ...
        final String pageContent = """
                ...
                <MAP NAME="map">
                 <AREA SHAPE=RECT COORDS="72,43,99,59" ALT="United States" HREF="rulu.html#united_states">
                 <AREA SHAPE=RECT COORDS="40,18,54,30" ALT="United States" HREF="rulu.html#united_states">
                 <AREA SHAPE=RECT COORDS="68,17,114,39" ALT="Canada" HREF="rulc1.html#canada">
                 <AREA SHAPE=RECT COORDS="196,16,294,31" ALT="Russia" HREF="rulqr.html#russia">
                 <AREA SHAPE=RECT COORDS="257,108,281,128" ALT="Australia" HREF="rula2.html#australia">
                 <AREA SHAPE=RECT COORDS="123,93,132,116" ALT="Brazil" HREF="rulb2.html#brazil">
                 <AREA SHAPE=RECT COORDS="232,49,256,61" ALT="China" HREF="rulc2.html#china">
                 <AREA SHAPE=RECT COORDS="238,40,247,46" ALT="Mongolia" HREF="rulm2.html#mongolia">
                 <AREA SHAPE=RECT COORDS="114,119,118,141" ALT="Argentina" HREF="rula2.html#argentina">
                 <AREA SHAPE=RECT COORDS="80,63,90,74" ALT="Mexico" HREF="rulm2.html#mexico">
                 <AREA SHAPE=RECT COORDS="221,65,228,81" ALT="India" HREF="ruli.html#india">
                 <AREA SHAPE=RECT COORDS="212,37,224,46" ALT="Kazakhstan" HREF="ruljk.html#kazakhstan">
                 <AREA SHAPE=RECT COORDS="295,128,300,138" ALT="New Zealand" HREF="ruln1.html#new_zealand">
                 <AREA SHAPE=RECT COORDS="269,51,274,56" ALT="Japan" HREF="ruljk.html#japan">
                 <AREA SHAPE=RECT COORDS="195,64,202,73" ALT="Saudi Arabia" HREF="ruls1.html#saudi_arabia">
                 <AREA SHAPE=RECT COORDS="204,54,209,62" ALT="Iran" HREF="ruli.html#iran">
                 <AREA SHAPE=RECT COORDS="181,90,186,99" ALT="Congo (Kinshasa)" HREF="rulc3.html#congo_kinshasa">
                 <AREA SHAPE=RECT COORDS="183,70,188,80" ALT="The Sudan" HREF="ruls3.html#sudan">
                 <AREA SHAPE=RECT COORDS="180,122,186,128" ALT="South Africa" HREF="ruls2.html#south_africa">
                 <AREA SHAPE=RECT COORDS="164,60,171,68" ALT="Algeria" HREF="rula1.html#algeria">
                </MAP>
                <H1><IMG SRC="rulers.gif" ALIGN="Left" ALT="Rulers" USEMAP="#map" BORDER=0></H1>
                ...
                src="http://e0.extreme-dm.com/s9.g?login=rulers0&amp;j=n&amp;jv=n" />
                </div></noscript></div>
        ...
        while (matcher.find()) {
            ...
            for (int matchIdx = 1; matchIdx <= matcher.groupCount(); matchIdx++) {
                System.out.println("Group " + matchIdx + ": " + matcher.group(matchIdx));
            }

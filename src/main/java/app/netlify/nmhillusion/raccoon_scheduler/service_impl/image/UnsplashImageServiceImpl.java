package app.netlify.nmhillusion.raccoon_scheduler.service_impl.image;

import app.netlify.nmhillusion.raccoon_scheduler.entity.image.unsplash.UnsplashImageEntity;
import app.netlify.nmhillusion.raccoon_scheduler.service.image.UnsplashImageService;
    ...
    private void postToStorageBucket(byte[] imageData) throws Throwable {
        FirebaseWrapper.getInstance()
                .runWithWrapper(firebaseHelper -> {
                    ...
                    final Bucket defaultBucket_ = storageClient.bucket("abc_");

                    final Blob blob_ = defaultBucket_.create(
                            "unsplash-wallpaper.jpg",
                            imageData,
                            "image/jpg"
                    );
